...
local communication. Kani supports using local or remote MCP tools, so that you can use the broad MCP ecosystem with
...
For example, here's how to connect to 3 MCP servers using Kani:
