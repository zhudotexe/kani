...
class StreamManager:
    ...
    def __init__(self, stream_iter: AsyncIterable[str | BaseCompletion], *, after=None, lock: asyncio.Lock = None):
        """
    ...
    async def _stream_impl_outer(self):
        # simple wrapper to lock the lock too
    ...
    def __await__(self):
        ...
        return (yield from self.message().__await__())
